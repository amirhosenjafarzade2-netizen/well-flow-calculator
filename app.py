...
def main():
    ...
    with tabs[0]:
        try:
            ...
            elif mode == "Bottomhole Pressure Predictor":
                run_ml_predictor()
    ...
    with tabs[1]:
        ...
        **Well Pressure and Depth Calculator**
        ...
        - **Bottomhole Pressure Predictor**: Train an ML model on generated data to predict bottomhole flowing pressure (p2) from inputs: wellhead pressure (p1), well length (D), conduit size, production rate, and GLR. Selectable models: Neural Network, Random Forest, Gradient Boosting, Stacking Ensemble.
